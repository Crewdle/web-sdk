...
import { IFile, updateUserList } from '../chat/helpers';
import { clearMessage, getMessage, removeMessage, renderMessage, updateMessage } from './helpers';
...
export async function send(userId: string) {
