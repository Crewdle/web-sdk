...
/**
 * TODO rename ClusterOptions
 * Add type ClusterOptions
 * Expose getMaximumNodes => Explain past this treshold, provided max options (connections, distance) will be broken but network will still work
 * Expose getClusterStatus => {maxNodes, currentNodesCount, avgConnectionsPerNode, totalConnections}
 * // TODO Future improvement - Allow changing the maxConnections and maxDistance triggering a rebalance
 */
/**
